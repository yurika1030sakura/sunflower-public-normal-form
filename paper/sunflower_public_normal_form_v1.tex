...
old window.  All later selectors are required to be measurable with respect to
the conditional law on this coarsened event and these retained variables.
...
measurable with respect to the quotient state.  Hence the discarded

...
This standalone appendix accompanies \texttt{sunflower\_manuscriptversion.pdf}.
It contains the retained transition certificates, branchwise charge checks,
numerical transfer estimates, and activation checks used by the readable
manuscript.
